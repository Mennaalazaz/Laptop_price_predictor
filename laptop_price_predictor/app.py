...
# import the model
pipe = pickle.load(open('Laptop_price_predictor/laptop_price_predictor/pipe.pkl','rb'))
df = pickle.load(open('Laptop_price_predictor/laptop_price_predictor/df.pkl','rb'))
